...
var scrolltotop = {
    ...
    controlHTML:'<img src="http://huynq.net/img/scroll.png" style="filter:alpha(opacity=70); -moz-opacity:0.7; width:55px; height:55px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
